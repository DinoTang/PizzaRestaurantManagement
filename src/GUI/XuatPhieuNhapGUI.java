...
public class XuatPhieuNhapGUI extends javax.swing.JDialog {
    ...
    private ArrayList<CTPhieuNhapDTO> listCTPhieuNhap = null;
    private int tongTien;
    private boolean checkNhap = false;
    String nhaCungCap;
    String nhanVien;

    public XuatPhieuNhapGUI(String nhaCungCap, String nhanVien, ArrayList<CTPhieuNhapDTO> listCTPhieuNhap) {
//        Main.changLNF("Windows");
        ...
        for (CTPhieuNhapDTO ctpn : this.listCTPhieuNhap) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        List<SanPhamDTO> dssp = sanPhamBUS.getAllSanPham();
        ...
        hd += "<tr>"
                ...
                + "<th>Thành tiền</th>"
                + "</tr>";
        for (CTPhieuNhapDTO ctpn : listCTPhieuNhap) {
            hd += "<tr>";
            hd += "<td style='text-align:center;'>" + ctpn.getMaNguyenLieu() + "</td>";
            for (SanPhamDTO sp : dssp) {
                if (sp.getMaSP().equals(ctpn.getMaNguyenLieu())) {
