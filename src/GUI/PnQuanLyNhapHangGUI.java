...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnTableLayout.setVerticalGroup(
            ...
            .addGroup(pnTableLayout.createSequentialGroup()
                ...
                .addComponent(scrTblKho, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnNhapHangLayout.setHorizontalGroup(
            ...
            .addGroup(pnNhapHangLayout.createSequentialGroup()
                .addComponent(pnTable, javax.swing.GroupLayout.PREFERRED_SIZE, 695, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(69, 69, 69)
        ...
        pnThongTinCTLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnThongTinCTLayout.createSequentialGroup()
                ...
                .addGroup(pnThongTinCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanel17, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 771, Short.MAX_VALUE)))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnThongTinCTLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    for (NguyenLieuDTO nl : dsnl) {
        ...
        vec.add(nl.getTenNguyenLieu());
        vec.add(nl.getTonKho());
        dtmKho.addRow(vec);
    }
    }
    ...
    private void loadDataTableKho(String tuKhoa) {
        dtmKho.setRowCount(0);
        List<NguyenLieuDTO> dsnl = nguyenLieuBUS.getNguyenLieuTheoTen(tuKhoa);
        for (NguyenLieuDTO nl : dsnl) {
                Vector vec = new Vector();
                vec.add(nl.getMaNguyenLieu());
                vec.add(nl.getTenNguyenLieu());
    ...
    private void loadDataCmbNhanVien() {
        ...
        for (int i = 0; i < cmbNhanVien.getItemCount(); i++) {
            ...
            if (cmbValue[0].equals(this.maNV)) {
    ...
    private void loadDataTablePhieuNhap() {
        List<PhieuNhapDTO> dspn = phieuNhapBUS.getListPhieuNhap();
        duaDataVaoTablePhieuNhap(dspn);
    }

    private void duaDataVaoTablePhieuNhap(List<PhieuNhapDTO> dspn) {
        if (dspn != null) {
    ...
    private void loadDataTablePhieuNhapTheoGia(String giaThap, String giaCao) {
        ...
        ArrayList<PhieuNhapDTO> dspn = phieuNhapBUS.getListPhieuNhapTheoGia(giaThap, giaCao);
        duaDataVaoTablePhieuNhap(dspn);
    }

    private void loadDataTablePhieuNhapTheoNgay(String tuNgay, String denNgay) {
        phieuNhapBUS.docDanhSach();
        ArrayList<PhieuNhapDTO> dspn = phieuNhapBUS.getListPhieuNhapTheoNgay(tuNgay, denNgay);
        duaDataVaoTablePhieuNhap(dspn);
    }

    private void loadDataTableCTPhieuNhap() {
        dtmCTPhieuNhap.setRowCount(0);
        List<CTPhieuNhapDTO> dsct = ctPhieuNhapBUS.getListPhieuNhap();
        if (dsct != null) {
            for (CTPhieuNhapDTO ct : dsct) {
                Vector vec = new Vector();
                vec.add(ct.getMaNguyenLieu());
    ...
    private void loadDataTableCTPhieuNhap(String maPN) {
        dtmCTPhieuNhap.setRowCount(0);
        List<CTPhieuNhapDTO> dsct = ctPhieuNhapBUS.getListPhieuNhap(maPN);
        if (dsct != null) {
            for (CTPhieuNhapDTO ct : dsct) {
                Vector vec = new Vector();
                vec.add(ct.getMaNguyenLieu());
    ...
    if (row >= 0) {
        ...
        String tenSP = tblKho.getValueAt(row, 1).toString();
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        for (int i = 0; i < row; i++) {
            String maNguyenLieu = tblGioNhap.getValueAt(i, 0).toString();
            ...
            CTPhieuNhapDTO ctpn = new CTPhieuNhapDTO("", maNguyenLieu, soLuong, donGia, thanhTien);
            dsct.add(ctpn);
        }
...
//            nguyenLieuBUS.getAllNguyenLieu();
            loadDataTableKho();
        }
    ...
    private void tblPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhieuNhapMouseClicked
        ...
        PhieuNhapDTO pn = phieuNhapBUS.timPhieuNhap(maPN);
    ...
    private void tblCTPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTPhieuNhapMouseClicked
        ...
        String tenNguyenLieu = nguyenLieuBUS.getNguyenLieuById(tblCTPhieuNhap.getValueAt(row, 0).toString()).getTenNguyenLieu();
        txtCTSanPham.setText(tenNguyenLieu);
...
//        nguyenLieuBUS.docListNguyenLieu();
        loadDataTableKho();
        dtmGioNhap.setRowCount(0);
